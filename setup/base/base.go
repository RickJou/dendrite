...
import (
	...
	asinthttp "github.com/RickJou/dendrite/appservice/inthttp"
	federationAPI "github.com/RickJou/dendrite/federationapi/api"
	federationIntHTTP "github.com/RickJou/dendrite/federationapi/inthttp"
	keyserverAPI "github.com/RickJou/dendrite/keyserver/api"
	keyinthttp "github.com/RickJou/dendrite/keyserver/inthttp"
	roomserverAPI "github.com/RickJou/dendrite/roomserver/api"
	rsinthttp "github.com/RickJou/dendrite/roomserver/inthttp"
	...
	userapiinthttp "github.com/RickJou/dendrite/userapi/inthttp"
)
...
func NewBaseDendrite(cfg *config.Dendrite, componentName string, options ...BaseDendriteOptions) *BaseDendrite {
	...
	internal.SetupStdLogging()                            //设置日志格式
	internal.SetupHookLogging(cfg.Logging, componentName) //初始化日志
	internal.SetupPprof()                                 //初始化pprof监控
