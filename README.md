...
- A reverse proxy server, such as nginx, configured [like this sample](https://github.com/RickJou/dendrite/blob/master/docs/nginx/monolith-sample.conf)
...
```bash
$ git clone https://github.com/RickJou/dendrite
$ cd dendrite
$ ./build.sh
...
[Are We Synapse Yet](https://github.com/RickJou/dendrite/labels/are-we-synapse-yet). These issues
...
look for [Good First Issues](https://github.com/RickJou/dendrite/labels/good%20first%20issue). If you're
familiar with the project, look for [Help Wanted](https://github.com/RickJou/dendrite/labels/help-wanted)
issues.
